...
def data_air_quality_with_loc_method(input_data_frame: pd.DataFrame):
    with open('air_quality_index.json', 'r') as investigated_source:
        ...
        # print('********************************************************************')
        # print(type(input_data_frame['param_formula']))
        # print('********************************************************************')
        # print(type(investigated_compounds["Compound"].keys()))
...
# data_frame = data_air_quality_without_loc_method(outcome_data_frame)

other_data_frame = data_air_quality_with_loc_method(outcome_data_frame)

# print(data_frame.to_string())
print(other_data_frame.to_string())
